...
class Application(GUI):
    def __init__(self):
        ...
        self.moving_mouse_x = 0
        self.moving_mouse_y = 0
        self.sole_rectangle = 0
    ...
    def config_gui(self):
        ...
        self.bind('<Control-o>', lambda _: self.open_img())
        self.bind('<Double-Button-1>', lambda _: self.open_img())
        self.bind('<Control-s>', lambda _: self.convert())
    ...
    def _open_img(self, img_path):
        ...
        self.canvas_img.config(
            width=self.image.new_size[0], height=self.image.new_size[1]
        )
